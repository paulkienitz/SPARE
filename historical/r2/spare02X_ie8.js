...
// In this version we strip out the alternate paths from SPARE 01 and use only XHR's text mode, retaining
// API compatibility (hopefully with improved performance), but no longer supporting IE 7.

// TODO: FIX FALLBACK FOR IE 9 -- writing to a div merges head elements into the body... SPARE 01 did this in IE 9, 10, and 11!
//       (Edge was OK.)  (insertAdjacentHTML also merges head elements, DOMParser throws errors because it wants XML, ...what else is there?)
//
// TESTS: Chrome/W: good, Chrome/A: good, Firefox Q69: good, Firefox 56: good, Safari 10/M: good, Safari 11/i: good, Edge 16: no U,
//        IE11: no U, IE10/em: no U, IE9/em: *iffy body* no UFH no bad, IE8/em: no UFH no bad, IE8/real: no UFH no bad.
// (Notes: "no U" = URLSearchParams not supported; "no UFH" = URLSearchParams, FormData, and history.pushstate all not supported;
// "no bad" = source with bad markup failed to produce content; "iffy body" means bogus head strip hack had to be used.)
